---
layout: post
title:  "New version 1.11.0"
date:   2025-09-11 20:00:00 +0100
tags: ['new version']
---
...
The [stormpy](https://stormchecker.github.io/stormpy/) Python bindings are also released in a new version 1.11.1 that comes with a restructured build process.
Stormpy can now be simply installed via `pip install stormpy` without any need installing Storm beforehand.

For detailed information on all the changes, please check the [release notes of Storm](https://github.com/stormchecker/storm/releases/tag/1.11.0) and the [release notes of stormpy](https://github.com/stormchecker/stormpy/releases/tag/1.11.0).
