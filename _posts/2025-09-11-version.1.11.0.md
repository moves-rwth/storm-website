...
The [stormpy](https://moves-rwth.github.io/stormpy/) Python bindings are also released in a new version 1.11.1 that comes with a restructured build process.
Stormpy can now be simply installed via `pip install stormpy` without any need installing Storm beforehand.

For detailed information on all the changes, please check the [release notes of Storm](https://github.com/moves-rwth/storm/releases/tag/1.11.0) and the [release notes of stormpy](https://github.com/moves-rwth/stormpy/releases/tag/1.11.0).
