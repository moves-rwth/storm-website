...
The [stormpy](https://stormchecker.github.io/stormpy/) Python bindings are also released in a new version compatible with Storm 1.9.0.

For detailed information on all the changes, please check the [release notes of Storm](https://github.com/stormchecker/storm/releases/tag/1.9.0) and the [release notes of stormpy](https://github.com/stormchecker/stormpy/releases/tag/1.9.0).
