...
For detailed information on all the changes, please check the [release notes of Storm](https://github.com/stormchecker/storm/releases/tag/1.8.0) and the [release notes of stormpy](https://github.com/stormchecker/stormpy/releases/tag/1.8.0).
