...
```console
sudo apt-get install build-essential git cmake libboost-dev libcln-dev libgmp-dev libginac-dev automake libglpk-dev libhwloc-dev libarchive-dev libz3-dev libxerces-c-dev
```
